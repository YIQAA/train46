    ...
    >
      ...
      >
        ...
        <template #amount="{ text, record }">
          ...
          <div :style="{ color: 'orange' }">￥{{ record?.amount  }}</div>
        </template>
...
import CarInfo from './components/show-card-info/index.vue'
import EditContent from './components/edit-content/index.vue'
import RefundTicket from './components/refund-ticket/index.vue'
