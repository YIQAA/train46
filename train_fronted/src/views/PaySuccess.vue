...
import { fetchOrderBySn, fechUserInfo } from '@/service/index.js'
...
import { getWeekNumber } from '@/utils/index.js'
...
onMounted(() => {
  ...
  fechUserInfo({ username: localStorage.getItem('userName') }).then((res) => {
    state.userInfo = res
  })
})
</script>
