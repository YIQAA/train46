...
//	}
//
////	,"/userself","/profile","/password","/password_fail","/publishhouse","/myhouse",
////			"/updateusername","/showprofile","/updatemyhouse","/changeHead",
////			"/admin","/adminhouse","/adminadd","/adminmain","/adminpwd","/adminpwd_fail"
////			,"houseSearchPage"
//	// configure(HttpSecurity http)方法中用于配置验证方式和资源的授权（什么角色可以访问什么资源）
//	@Override
//	protected void configure(HttpSecurity http) throws Exception {
//		http.authorizeRequests()
//				.antMatchers("/","/index","/housedetail",
//						"/toLogin","/toRegister","/register_fail","/register","/register_succeed","/update_fail",
...
//					.loginPage("/toLogin") //自定义的登录页面是有要求的，要求具体参见login_page.html页面
